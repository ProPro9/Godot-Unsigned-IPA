class_name VoiceClipPreviewerBlockScene extends Control
...
@onready var voice_clip_toggle_previewer: VoiceClipTogglePreviewer = %VoiceClipTogglePreviewer





func set_pack(pack: PackInfo) -> void :
	...
	voice_clip_toggle_previewer.pack = pack
